...
export const novelosGuide: DocNode[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["AI Proofreader", "(Novelos only) Scans your chapter for grammar, punctuation and stylistic errors, offering author voice and context-aware corrections.", "The Engine"],
      ["Text Shortcuts", "Opens the Shortcuts Manager. Define custom expansions.", "The Engine"],
      ["Find & Replace", "Opens a search dialog for Find and Replace that operates on the current chapter or entire manuscript.", "The Engine"],
  ...
  { type: "heading", level: 5, content: "Importing Noveli back to Novelos" },
  {
    type: "list",
    items: [
      "In Noveli: Export/Save to generate ZIP.",
  ...
  { type: "heading", level: 5, content: "The Rescue Protocol (Crash Recovery)" },
  {
    type: "paragraph",
    content:
      "If a critical error occurs, a Rescue Mode allows Download Rescue Backup to generate an emergency JSON dump so words are never lost.",
  },
  { type: "heading", level: 3, content: "SECTION B: ASSEMBLY MODE" },
  {
    type: "paragraph",
    content:
